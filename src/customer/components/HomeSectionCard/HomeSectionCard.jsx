    ...
    return (
        ...
        overflow-hidden w-[15rem] mx-3 border border-black'>
            ...
            <div className='h-[13rem] w-[10rem]'>
                <img className='object-cover object-top w-full h-full' src="https://thumbs.dreamstime.com/b/fashion-clothes-short-sleeve-shirt-jeans-mens-photos-made-white-background-148909387.jpg"
                    alt="" />
            </div>
